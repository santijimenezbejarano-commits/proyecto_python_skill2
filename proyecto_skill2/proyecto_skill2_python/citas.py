...
from utilidades import (validar_fecha, validar_hora, es_fecha_futura,es_hora_futura, limpiar_entrada,obtener_entrada_segura,validar_estado,esta_activo,esta_inactivo
)
            ...
            if opcion == "1":
                ...
                try:
                    ...
                    hora = obtener_entrada_segura(
                        "Hora (HH:MM): ",
                        validador=lambda x: validar_hora(x) and es_hora_futura(x)
                    )
