...
from utilidades import validar_documento, validar_nombre, limpiar_entrada, obtener_entrada_segura
...
def menu_clientes():
        ...
        while True:
            ...
            if opcion == "1":
                ...
                entrada = input("📝 ID del cliente (enter para cancelar-si para continuar): ").strip()
                if entrada == "":
                    print("\n" + "="*21)
