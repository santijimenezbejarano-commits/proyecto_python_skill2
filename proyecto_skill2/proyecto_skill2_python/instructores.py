...
from utilidades import validar_documento, validar_nombre, limpiar_entrada, obtener_entrada_segura, esta_activo, esta_inactivo
...
def menu_instructores():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            entrada = input("📝ID del instructor (enter para cancelar): ").strip()
            if not ver_antes == "s":
                    print("\n" + "="*21)
