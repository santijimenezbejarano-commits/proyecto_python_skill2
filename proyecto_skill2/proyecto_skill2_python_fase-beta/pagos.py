        ...
        while True:
            ...
            if opcion == "1":
                ...
                try:
                    ...
                    registrar_pago(id_cliente, monto, metodo, id_cita_int, observaciones=observaciones)
                except ValueError:
                ...
                formatear_lista(listar_pagos(id_cliente), "Pagos")
                ...
                try:
                    ...
                    if actualizar_estado(id_pago, estado):
