        ...
        while True:
            ...
            if opcion == "1":
                ...
                tipo_vehiculo = obtener_entrada_segura(
                    "Tipo de vehículo: ",
                    validador=lambda x: x.lower() in Clientes.TIPOS_VALIDOS
                )
                
                Clientes.registrar_cliente(nombre, documento, tipo_vehiculo)
                ...
                formatear_lista(Clientes.listar_clientes(), "Clientes Activos")
