...
class Citas:
    """Gestiona operaciones con citas de práctica"""
    ...
    def programar_cita(id_cliente: int, id_instructor: int, id_vehiculo: int,
        ...
        """
        Programa una nueva cita de práctica
        ...
        Returns:
            Diccionario con datos de la cita o None si hay error
        """
    ...
    def registrar_asistencia(id_cita: int, asistio: bool, observaciones_practica: str = "") -> bool:
        """
        Registra asistencia y observaciones de una práctica
        
        Args:
            id_cita: ID de la cita
            asistio: True si asistió, False si no asistió
            observaciones_practica: Observaciones de la práctica realizada
            
        Returns:
            True si se registró, False si no existe
        """
        citas = cargar_datos(Citas.ARCHIVO)
    ...
    def listar_citas(id_cliente: int = None, fecha: str = None) -> list:
        """
        Lista citas, opcionalmente filtradas
        
        Args:
            id_cliente: Filtrar por cliente (opcional)
            fecha: Filtrar por fecha DD/MM/YYYY (opcional)
    ...
    def historial_cliente(id_cliente: int) -> list:
        ...
        """
        return Citas.listar_citas(id_cliente=id_cliente)
        ...
        while True:
            ...
            if opcion == "1":
                ...
                try:
                    ...
                    print(f"\nDuraciones disponibles (minutos): {Citas.DURACIONES_VALIDAS}")
                ...
                try:
                    ...
                    if Citas.registrar_asistencia(id_cita, asistio, observaciones):
                ...
                try:
                    ...
                    from utilidades import formatear_lista
                    formatear_lista(
                        Citas.historial_cliente(id_cliente),
                ...
                from utilidades import formatear_lista
                formatear_lista(
                    Citas.listar_citas(fecha=fecha),
                    f"Citas del {fecha}"
                )
