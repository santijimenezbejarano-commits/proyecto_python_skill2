...
class Vehiculos:
    """Gestiona operaciones con vehículos"""
        ...
        while True:
            ...
            if opcion == "1":
                ...
                tipo = obtener_entrada_segura(
                    "Tipo de vehículo: ",
                    validador=lambda x: x.lower() in Vehiculos.TIPOS_VALIDOS
                )
                ...
                Vehiculos.registrar_vehiculo(tipo, placa, modelo)
                ...
                if tipo in Vehiculos.TIPOS_VALIDOS:
                    from utilidades import formatear_lista
                    formatear_lista(
                        Vehiculos.listar_vehiculos(tipo=tipo),
